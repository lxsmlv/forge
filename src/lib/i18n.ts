...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'hub.pulse': 'Activity Pulse',
    'hub.actions': 'actions',
    'hub.action': 'action',
    'hub.active_days': 'active days',
    'hub.add_widget': 'Add widget',
    ...
    'qr.scan_hint': 'Scan to open profile',
    'qr.save': 'Save',
    'qr.share': 'Share',
    ...
    'common.delete_confirm': 'Delete this post?',
    'common.edit': 'Edit',
  ...
  ru: {
    ...
    'hub.dashboard': 'Обзор',
    'hub.pulse': 'Пульс активности',
    'hub.actions': 'действий',
    'hub.action': 'действие',
    'hub.active_days': 'активных дней',
    'hub.add_widget': 'Добавить виджет',
    ...
    'qr.scan_hint': 'Отсканируйте для перехода в профиль',
    'qr.save': 'Сохранить',
    'qr.share': 'Поделиться',
    ...
    'common.delete_confirm': 'Удалить этот пост?',
    'common.edit': 'Редактировать',
    'common.report': 'Пожаловаться',
    'common.reported': 'Жалоба отправлена',
